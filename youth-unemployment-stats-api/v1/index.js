...
module.exports = function (app, BASE_PATH, youth_unemployment_stats){
   ...
   // Proxy API 4
    ...
    app.use("/proxy/api/climate-stats", function(req, res){
        console.log("Piped: "+ API4);
        req.pipe(request(API4)).pipe(res);
    });
    ...
    //GET /api/v1/youth-unemployment-stats/loadInitialData
     app.get(BASE_PATH+"/youth-unemployment-stats/loadInitialData", (req, res) => {
        ...
        youth_unemployment_stats.insert({country: "Germany", year: 2017, youth_unemployment: 6.5, youth_unemployment_man: 7.2, youth_unemployment_woman: 5.6});
        youth_unemployment_stats.insert({country: "Germany", year: 2016, youth_unemployment: 6.7, youth_unemployment_man: 7.5, youth_unemployment_woman: 5.8});
        youth_unemployment_stats.insert({country: "Germany", year: 2015, youth_unemployment: 7.1, youth_unemployment_man: 7.7, youth_unemployment_woman: 6.4});
        youth_unemployment_stats.insert({country: "United Kingdom", year: 2017, youth_unemployment: 12.5, youth_unemployment_man: 13.5, youth_unemployment_woman: 11.4});
        youth_unemployment_stats.insert({country: "United Kingdom", year: 2016, youth_unemployment: 12.6, youth_unemployment_man: 14.8, youth_unemployment_woman: 10.1});
        youth_unemployment_stats.insert({country: "United Kingdom", year: 2015, youth_unemployment: 13.6, youth_unemployment_man: 14.8, youth_unemployment_woman: 12.3});
        youth_unemployment_stats.insert({country: "France", year: 2017, youth_unemployment: 21.6, youth_unemployment_man: 22.3, youth_unemployment_woman: 20.8});
        youth_unemployment_stats.insert({country: "France", year: 2016, youth_unemployment: 23.3, youth_unemployment_man: 24.3, youth_unemployment_woman: 22.1});
        youth_unemployment_stats.insert({country: "France", year: 2015, youth_unemployment: 24.5, youth_unemployment_man: 25.8, youth_unemployment_woman: 22.9});
        youth_unemployment_stats.insert({country: "Italy", year: 2017, youth_unemployment: 32.4, youth_unemployment_man: 31.2, youth_unemployment_woman: 36.2});
        youth_unemployment_stats.insert({country: "Italy", year: 2016, youth_unemployment: 38.2, youth_unemployment_man: 36.5, youth_unemployment_woman: 40.6});
        youth_unemployment_stats.insert({country: "Italy", year: 2015, youth_unemployment: 38.3, youth_unemployment_man: 37.9, youth_unemployment_woman: 39.5});
        ...
        youth_unemployment_stats.insert({country: "Finland", year: 2017, youth_unemployment: 18.5, youth_unemployment_man: 19.6, youth_unemployment_woman: 17.5});
        youth_unemployment_stats.insert({country: "Finland", year: 2016, youth_unemployment: 20.3, youth_unemployment_man: 21.2, youth_unemployment_woman: 19.3});
        youth_unemployment_stats.insert({country: "Finland", year: 2015, youth_unemployment: 21.7, youth_unemployment_man: 24.3, youth_unemployment_woman: 19.4});
        youth_unemployment_stats.insert({country: "Holland", year: 2017, youth_unemployment: 8.0, youth_unemployment_man: 8.6, youth_unemployment_woman: 7.5});
        youth_unemployment_stats.insert({country: "Holland", year: 2016, youth_unemployment: 10.2, youth_unemployment_man: 10.6, youth_unemployment_woman: 9.8});
        youth_unemployment_stats.insert({country: "Holland", year: 2015, youth_unemployment: 11.2, youth_unemployment_man: 11.5, youth_unemployment_woman: 10.8});
        youth_unemployment_stats.insert({country: "Ireland", year: 2017, youth_unemployment: 13.2, youth_unemployment_man: 14.4, youth_unemployment_woman: 11.8});
        youth_unemployment_stats.insert({country: "Ireland", year: 2016, youth_unemployment: 15.6, youth_unemployment_man: 17.3, youth_unemployment_woman: 13.8});
        youth_unemployment_stats.insert({country: "Ireland", year: 2015, youth_unemployment: 19.1, youth_unemployment_man: 23.0, youth_unemployment_woman: 14.7});
        youth_unemployment_stats.insert({country: "Croatia", year: 2017, youth_unemployment: 25.9, youth_unemployment_man: 23.7, youth_unemployment_woman: 29.0});
        youth_unemployment_stats.insert({country: "Croatia", year: 2016, youth_unemployment: 30.5, youth_unemployment_man: 31.0, youth_unemployment_woman: 29.8});
        youth_unemployment_stats.insert({country: "Croatia", year: 2015, youth_unemployment: 38.3, youth_unemployment_man: 36.8, youth_unemployment_woman: 40.3});
